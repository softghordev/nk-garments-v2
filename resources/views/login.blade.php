...
<head>
	...
	<meta name="description" content="zendbot.com is a one" />
	<meta property="og:title" content="zendbot" />
	<meta property="og:description" content="this application created by rakibjewel.com and powered by zendbot.com" />
                            ...
                            <div class="col-xl-12">
                                <div class="auth-form">
									<div class="text-center mb-3">
										<a href="{{ url('/') }}"><img src="{{asset('asset/images/logo.png')}}" alt="logo" width="60%"></a>
									</div>
