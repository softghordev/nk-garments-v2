...
<<<<<<< HEAD
                        ...
                        <select name="change_department" id="" onchange="javascript:handleSelect(this)" class="form-control">
=======
                        @if(session('department')!=null)
                        <div class="department">
                        @if(auth()->user()->hasAnyRole('admin') )
...
>>>>>>> 9066209 (Hello)
                        ...
                        @else
<<<<<<< HEAD
                            <a href="JavaScript:void(0)">{{ \App\Department::find(session('department'))->name }}</a>
                        @endif
                        </div>
                        {{-- @endif --}}
=======
