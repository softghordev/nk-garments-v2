...
<div class="content-body" style="min-height: 500px">
    <div class="container-fluid">
        <div class="card-header mb-3">
            <h4 class="card-title">Edit Party Purchase</h4>
        </div>
        <div class="basic-form">
            <form method="POST" action="{{ route('party-purchase.update',$party_purchase->id) }}">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-6">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                <select name="party_id" id="" class="form-control form-control-sm" required>
                                    ...
                                    <option value="{{$party->id}}" {{ $party_purchase->party_id == $party->id ? 'selected' : '' }}>{{$party->party_name}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                <div id="datepicker" class="input-group date" data-date-format="yyyy-mm-dd">
                                    <input class="form-control form-control-sm" type="text" value="{{$party_purchase->purchase_date}}" readonly
                                        name="purchase_date" />
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                <select name="order_by" id="" class="form-control form-control-sm">
                                    ...
                                    <option value="{{$employee->id}}" {{ $party_purchase->order_by == $employee->id ? 'selected' : '' }}>{{$employee->employee_name}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-sm-9">
                                <div id="datepicker2" class="input-group date" data-date-format="yyyy-mm-dd">
                                    <input class="form-control form-control-sm" type="text" readonly
                                        name="delivery_date" style="width: 100%" value="{{$party_purchase->delivery_date}}" />
                                    <span class="input-group-addon">
                                        <i class="glyphicon glyphicon-calendar"></i>
                                    </span>
                                </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                <select name="purchase_by" id="" class="form-control form-control-sm">
                                    ...
                                    @foreach($employees as $employee)
                                    <option value="{{$employee->id}}" {{ $party_purchase->purchase_by == $employee->id ? 'selected' : '' }}>{{$employee->employee_name}}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="col-6">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                <textarea name="note" id="" cols="60" rows="1" class="form-control form-control-sm">{{$party_purchase->note}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-responsive-md mytable">
                                ...
                                <tbody>
                                    @foreach ($party_purchase->items as $key => $old_item )
                                    <tr>
                                         <td>
                                ...
                                <table class="table table-responsive-md">
                                    <thead>
                                        <tr style="width: 100%">
                                            ...
                                            <th>
                                                <input type="text" name="payable" id="input_payable" class="form-control form-control-sm" value="{{$party_purchase->final_payable}}" readonly>
                                            </th>
                                        </tr>
                                    </thead>
                                </table>
