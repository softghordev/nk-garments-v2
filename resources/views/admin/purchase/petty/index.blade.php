...
<<<<<<< HEAD
                                    <option value="{{$employee->employee_name}}" {{ request('purchase_by')==$employee->employee_name?'SELECTED':'' }}>{{$employee->employee_name}}</option>
=======
...
>>>>>>> 9066209 (Hello)
                                   ...
                                   <td>
<<<<<<< HEAD
                                    <span class="badge light badge-{{ $purchase->delivery_status ? 'success' : 'warning' }}">{{ $purchase->delivery_status ? 'Delivered' : 'Pending' }}</span>
=======
                                       <span
