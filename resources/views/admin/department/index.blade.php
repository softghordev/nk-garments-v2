                ...
                <div class="basic-form">
                    <form>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control input-rounded" placeholder="size" name="size">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Weight</label>
                            <input type="text" class="form-control input-rounded" placeholder="size" name="weight">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Color</label>
                            <input type="text" class="form-control input-rounded" placeholder="size" name="color">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Count</label>
                            <input type="text" class="form-control input-rounded" placeholder="size" name="count">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Brand</label>
                            <input type="text" class="form-control input-rounded" placeholder="size" name="brand">
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="basic-form">
                    <form>
                        ...
                        <select class="default-select size-2 form-control wide mb-3">
                            <option>Option 1</option>
                            <option>Option 2</option>
                            <option>Option 3</option>
                        </select>
                        <select class="default-select size-3 form-control wide">
                            <option>Option 1</option>
                            <option>Option 2</option>
                            <option>Option 3</option>
                        </select>
