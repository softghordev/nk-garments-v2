...
<div class="content-body" style="min-height: 500px">
    <div class="container-fluid">
        <div class="card-header mb-3">
            <h4 class="card-title">Edit Party Sale</h4>
        </div>
        <div class="basic-form">
            <form method="POST" action="{{ route('party-sale.update',$party_sale->id) }}">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-6">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                <select name="showroom" id="" class="form-control form-control-sm">
                                    ...
                                    <option value="{{$showroom->name}}" {{ $party_sale->showroom == $showroom->name ? 'selected' : '' }}>{{$showroom->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-9">
                                <div id="datepicker2" class="input-group date" data-date-format="yyyy-mm-dd">
                                    <input class="form-control form-control-sm" type="text" readonly
                                        name="delivery_date" style="width: 100%" value="{{$party_sale->delivery_date}}" />
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                <select name="sale_type" id="" class="form-control form-control-sm">
                                    ...
                                    <option value="Party Sales(Regular Item)" {{ $party_sale->sale_type =="Party Sales(Regular Item)" ? 'selected' : '' }}>Party Sales(Regular Item)</option>
                                </select>
                    ...
                    <div class="col-6">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                <textarea name="delivery_to" id="" cols="60" rows="1" class="form-control form-control-sm">{{$party_sale->delivery_to}}</textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                <select name="party_id" id="" class="form-control form-control-sm" required>
                                    ...
                                    <option value="{{$party->id}}" {{ $party_sale->party_id == $party->id ? 'selected' : '' }}>{{$party->party_name}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                <select name="sold_by" id="" class="form-control form-control-sm">
                                    ...
                                    <option value="{{$employee->id}}" {{ $party_sale->sold_by == $employee->id ? 'selected' : '' }}>{{$employee->employee_name}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                <div id="datepicker" class="input-group date" data-date-format="yyyy-mm-dd">
                                    <input class="form-control form-control-sm" type="text" readonly
                                        name="sale_date" value="{{$party_sale->sale_date}}" />
                                    <span class="input-group-addon">
                                        <i class="glyphicon glyphicon-calendar"></i>
                                    </span>
                                </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                <select name="order_by" id="" class="form-control form-control-sm">
                                    ...
                                    @foreach($employees as $employee)
                                    <option value="{{$employee->id}}" {{ $party_sale->order_by == $employee->id ? 'selected' : '' }}>{{$employee->employee_name}}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="col-6">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                <textarea name="note" id="" cols="60" rows="1" class="form-control form-control-sm">{{$party_sale->note}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-responsive-md mytable">
                                ...
                                <tbody>
                                    @foreach ($party_sale->items as $key => $old_item )
                                    <tr>
                                         <td>
                                ...
                                <table class="table table-responsive-md">
                                    <thead>
                                        <tr style="width: 100%">
                                            ...
                                            <th>
                                                <input type="text" name="receivable" id="input_receivable" class="form-control form-control-sm" value="{{$party_sale->final_receivable}}" readonly>
                                            </th>
                                        </tr>
                                        ...
                                        <tr style="width: 100%">
                                            ...
                                            <th>
                                                <input type="text" name="total_discount" id="input_discount" class="form-control form-control-sm" value="{{$party_sale->total_discount}}">
                                            </th>
                                        </tr>
                                        ...
                                        <tr style="width: 100%">
                                            ...
                                            <th>
                                                <input type="text" name="total_commission" id="input_commission" class="form-control form-control-sm" value="{{$party_sale->total_commission}}" readonly>
                                            </th>
                                        </tr>
                                    </thead>
                                </table>
