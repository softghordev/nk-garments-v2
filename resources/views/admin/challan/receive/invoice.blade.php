    ...
    <div class="container-fluid">
        <div class="card mt-3">
            <div class="card-header">
                <h3><strong>Receive Challan Invoice</strong></h3>
                    ...
                    <div class="row mb-5">
                        <div class="mt-4 col-xl-6 col-lg-6 col-md-6 col-sm-6">
                            <div class="party_info">
                                ...
                                <div class="name"><strong>Party Name: {{$challan->party->party_name}}</strong></div>
                                <div class="phone_no"><strong>Phone Number: {{$challan->party->phone}}</strong></div>
                                <div class="sale_date"><strong>Purchase Date: {{date('d M, Y', strtotime($challan->purchase_date))}}</strong></div>
