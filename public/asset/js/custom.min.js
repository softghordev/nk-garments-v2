...
var Mophy = function(){
	...
	var handledarkgallery = function (){
		if(jQuery('#darkgallery, .darkgallery').length>0) {
			$('#darkgallery, .darkgallery').darkGallery({
				thumbnail:true,
			});
		}
	}
...
document.addEventListener('DOMContentLoaded', function() {
    function updateDateTime() {
        ...
        var currentDateTime = new Date().toLocaleString(undefined, options);

        // Extracting components
        var [month, day, year, time, period] = currentDateTime.split(/[/, ]+/);

        // Creating the new date string in dd/mm/yyyy format
        var formattedDate = `${day}/${month}/${year}`;

        // Combining the date and time
        dateTimeElement.textContent = 'Date and Time: ' + formattedDate + ', ' + time + ' ' + period;
    }
